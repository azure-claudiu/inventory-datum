"""
SnowflakeSqliteGenerator — reads snowflake_table_columns.csv, creates snowflake.db
...
Usage
-----
    gen = SnowflakeSqliteGenerator()   # creates snowflake.db, builds schema from CSV
    gen.seed()                   # inserts N=10 rows per table
    gen.close()

Or as a one-shot:
    python snowflake_gen_sqlite.py
"""
...
class SnowflakeSqliteGenerator:
    """
